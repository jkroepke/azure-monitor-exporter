...
func TestProbe(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedMetrics: []string{
				`azure_monitor_microsoft_compute_virtualmachines_vmavailabilitymetric_average_count{region="westeurope",instance="/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-mock/providers/Microsoft.Compute/virtualMachines/vm1",subscription_id="00000000-0000-0000-0000-000000000000"} 1`,
			},
		},
		{
			name:          "lager probe",
